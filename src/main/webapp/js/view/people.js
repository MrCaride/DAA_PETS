var PeopleView = (function() {
	...
	var addRowListeners = function(person) {
		...
		$('#person-' + person.id + ' a.manage-pets').click(function() {
			// Ocultar la vista de personas
			$('#people-container').hide();
			// Mostrar la vista de mascotas
			$('#pets-container').show();
			// Inicializar la vista de mascotas para esta persona
